          ...
          {selectedLocation && (
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-semibold text-sv-red-100 mb-1">Selected Location</p>
                  {isLoadingLocation ? (
                    <p className="text-xs text-sv-red-300/60">Loading location...</p>
                  ) : (
                    <>
            ...
            <div className="grid grid-cols-2 gap-3">
              {INCIDENT_TYPES.map((type) => (
                ...
                >
                  ...
                  <div className="text-sm font-medium text-sv-red-100">{type.label}</div>
                </button>
              ))}
            </div>
          </div>
